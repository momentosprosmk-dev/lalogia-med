document.addEventListener("DOMContentLoaded", () => {
  ...
  const recursos = [
    ...
    basemedia + "cervesa/cerveza_corona.avif",
    basemedia + "cervesa/cerveza_heineken.avif",
    basemedia + "cervesa/cerveza_sol.avif",
    basemedia + "cervesa/cerveza_stella_artois.avif",

    basemedia + "acompanantes/agua.avif",
    basemedia + "acompanantes/agua_tonica_mil976_cero_calorias.avif",
    basemedia + "acompanantes/agua_tonica_mil976_indi.avif",
    basemedia + "acompanantes/agua_tonica_mil976_ocean.avif",
    basemedia + "acompanantes/agua_tonica_mil976_pink.avif",
    basemedia + "acompanantes/canada_dry.avif",
    basemedia + "acompanantes/drinko_mora_azul.avif",
    basemedia + "acompanantes/drinko_naranja.avif",
    basemedia + "acompanantes/drinko_water_melon.avif",
    basemedia + "acompanantes/electrolit_fresa.avif",
    basemedia + "acompanantes/electrolit_fresa_kiwi.avif",
    basemedia + "acompanantes/electrolit_maracuya.avif",
    basemedia + "acompanantes/electrolit_mora_azul.avif",
    basemedia + "acompanantes/electrolit_ponche_frutas.avif",
    basemedia + "acompanantes/electrolit_uva.avif",
    basemedia + "acompanantes/gatorade_blue_ice.avif",
    basemedia + "acompanantes/gatorade_frutas_tropicales.avif",
    basemedia + "acompanantes/gatorade_mandarina.avif",
    basemedia + "acompanantes/gatorade_maracuya.avif",
    basemedia + "acompanantes/gatorade_sin_azucar_fresa_kiwi.avif",
    basemedia + "acompanantes/gatorade_sin_azucar_naranja.avif",
    basemedia + "acompanantes/jarra_de_arandano.avif",
    basemedia + "acompanantes/jarra_de_naranja.avif",
    basemedia + "acompanantes/pepsi.avif",
    basemedia + "acompanantes/red_bull_energy_drink.avif",
    basemedia + "acompanantes/red_bull_sugarfree.avif",
    basemedia + "acompanantes/red_bull_zero.avif",
    basemedia + "acompanantes/smirnoff_ice_green_apple_personal.avif",
    basemedia + "acompanantes/smirnoff_ice_original_personal.avif",
